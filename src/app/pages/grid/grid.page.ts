...
@Component({
  ...
  standalone: true,
  imports: [IonCardContent, IonCardTitle, IonCardHeader, IonCardSubtitle, IonImg, IonCard, IonCol, IonRow, IonGrid, IonContent, CommonModule, FormsModule, HeaderComponent]
})
